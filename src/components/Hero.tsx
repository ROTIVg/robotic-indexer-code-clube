  ...
  return <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 animate-slide-down" style={{
          animationDelay: "0.1s"
        }}>
            Inovação e Tecnologia no <span className="text-code-green">Code</span><span className="text-code-red">Clube</span>
          </h1>
          
          <p className="text-lg text-gray-600 mb-8 animate-slide-down" style={{
          animationDelay: "0.2s"
        }}>
      ...
      <button onClick={scrollToNext} className="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-gray-500 hover:text-gray-700 transition-colors animate-bounce" aria-label="Rolar para baixo">
        <ChevronDown size={24} />
      </button>
    </section>;
};
