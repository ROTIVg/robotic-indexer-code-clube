        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Receba novidades e atualizações sobre nossos projetos e eventos.
            </p>
            <form className="space-y-3">
              <input 
                type="email" 
                placeholder="Seu e-mail" 
                className="w-full px-4 py-2 rounded-lg bg-gray-800 border border-gray-700 text-gray-200 focus:outline-none focus:border-code-green"
              />
              <button 
                type="submit" 
                className="w-full bg-code-green hover:bg-code-green/90 text-white px-4 py-2 rounded-lg font-medium btn-transition"
              >
                Inscrever-se
              </button>
            </form>
