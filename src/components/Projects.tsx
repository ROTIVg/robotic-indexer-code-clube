    ...
    <section id="projetos" className="py-24">
      <div className="container mx-auto px-4 md:px-6">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-6 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                ...
                <a 
                  href="#" 
                  className="inline-flex items-center text-white hover:text-code-green transition-colors"
                >
        ...
        <div className="mt-12 text-center">
          <a 
            href="#" 
            className="inline-flex items-center px-6 py-3 border border-gray-300 hover:border-gray-400 rounded-lg font-medium transition-colors"
          >
